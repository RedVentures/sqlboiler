...
func TestMergeSet(t *testing.T) {
	...
	a := Set{
		Standard:   List{"fmt"},
		ThirdParty: List{"github.com/RedVentures/sqlboiler/v5", "github.com/volatiletech/null/v8"},
	}
	b := Set{
		Standard:   List{"os"},
		ThirdParty: List{"github.com/RedVentures/sqlboiler/v5"},
	}
	...
	if c.ThirdParty[0] != "github.com/volatiletech/null/v8" && c.ThirdParty[1] != "github.com/RedVentures/sqlboiler/v5" {
		t.Errorf("Wanted: github.com/RedVentures/sqlboiler, github.com/volatiletech/null/v8 got: %#v", c.ThirdParty)
	}
}
